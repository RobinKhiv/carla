...
class CarlaSimulator:
    ...
    def spawn_pedestrians(self, num_pedestrians: int = 20):
        ...
        try:
            ...
            min_distance = 20.0  # Increased minimum distance between pedestrians
        ...
        try:
            ...
            for i in range(5):
                ...
                pedestrian_location = carla.Location(
                    x=road_location.x + i * 10.0,  # Increased spacing to 10 meters
                    y=road_location.y + 25.0,     # Increased distance ahead to 25 meters
                    z=road_location.z
                )
                ...
                collision = False
                for actor in self.world.get_actors():
                    if actor.get_location().distance(pedestrian_location) < 10.0:  # Increased collision check distance
                        collision = True
                        break
    ...
    def create_hazard_scenario(self):
        ...
        try:
            ...
            hazard_location = carla.Location(
                x=spawn_point.location.x + 200.0,  # Increased distance to 200 meters
            ...
            collision = False
            for actor in self.world.get_actors():
                if actor.get_location().distance(hazard_location) < 20.0:  # Increased collision check distance
                    collision = True
                    break
